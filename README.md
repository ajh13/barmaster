...
- **Fixed, overhead, or both**: Show bars as movable RuneLite overlays, above character heads, or both at once. Player overhead stacks keep a constant pixel size/offset around your character while zooming and can be offset horizontally/vertically.
...
| Style | Text / background / border color | Global text, empty-bar, and optional border colors |
